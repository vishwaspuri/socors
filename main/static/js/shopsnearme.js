...
$(document).ready(function(){
        ...
        for(var i=0;i<shopRow.length; i++){

            if(shopRow[i].firstElementChild.lastElementChild.lastChild.classList=="closed"){
                shopRow[i].lastElementChild.lastElementChild.firstElementChild.classList.add('disabled');
                shopRow[i].lastElementChild.lastElementChild.firstElementChild.attributes.disabled=true;
            }
